...
Map minVersions()     { return [echoDevice: 3301, wsDevice: 3200, actionApp: 3320, zoneApp: 3320, server: 230] } //These values define the minimum versions of code this app will work with.
