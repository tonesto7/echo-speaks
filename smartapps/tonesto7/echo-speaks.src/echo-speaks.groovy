...
Map minVersions()     { return [echoDevice: 3600, wsDevice: 3200, actionApp: 3600, zoneApp: 3600, server: 240] } //These values define the minimum versions of code this app will work with.
