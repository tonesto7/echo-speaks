...
Map minVersions()     { return [echoDevice: 3201, wsDevice: 3200, actionApp: 3201, zoneApp: 3201, server: 230] } //These values define the minimum versions of code this app will work with.
