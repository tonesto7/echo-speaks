...
@Field static final Map minVersionsFLD    = [echoDevice: 4111, wsDevice: 4111, actionApp: 4111, zoneApp: 4111, zoneEchoDevice: 4111, server: 270]  //These values define the minimum versions of code this app will work with.
...
@Field static final Map deviceSupportMapFLD = [
    types: [
        ...
        "A1Q7QCGNMXAKYW" : [ b: true, i: "amazon_tablet", n: "Generic Tablet" ],
        ...
        "A2E0SNTXJVT7WK" : [ c: [ "a", "t" ], i: "firetv_gen1", n: "Fire TV (Gen2)" ],
        "A2GFL5ZMWNE0PX" : [ c: [ "a", "t" ], i: "firetv_gen1", n: "Fire TV (Gen3)" ],
        "AN630UQPG2CA4"  : [ c: [ "a", "t" ], i: "firetv_gen1", n: "Fire TV (Toshiba)" ],
